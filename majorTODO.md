...
6. **DM monster-control-surface and monster capability backend** — Phase 0 (Audit), Phase 1 (UI/Backend Vertical Slice), Phase 2 (Map/Movement), and Phase 3 (Action Resolution/Apply Results) landed. **2026-05-15 Update**: Fixed regressions in firearm ammo tracking (redundant manual instructions suppressed, prominent ammo blocks added, targeting mode persistence fixed, .45 reserves refined). **2026-05-13 Update**: `/dmcontrol` resolution UX refined.
