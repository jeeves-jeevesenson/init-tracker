...
| Slug | Name | Caps | Exec | Save | Rech | Comp | Status |
|------|------|------|------|------|------|------|--------|
| adult-red-dragon | Adult Red Dragon | 10 | 6 | 3 | 1 | 1 | **Assisted Multiattack** |
| archmage | Archmage | 3 | 1 | 0 | 0 | 0 | **Display-only spells** |
| bandit | Bandit | 2 | 2 | 0 | 0 | 0 | **Safe to use** |
| bugbear-warrior | Bugbear | 4 | 2 | 0 | 0 | 0 | **Safe to use** |
| cultist | Cultist | 2 | 1 | 0 | 0 | 0 | **Safe to use** |
| goblin-warrior | Goblin | 3 | 2 | 0 | 0 | 0 | **Safe to use** |
| kobold-warrior | Kobold | 4 | 2 | 0 | 0 | 0 | **Safe to use** |
| ogre | Ogre | 2 | 2 | 0 | 0 | 0 | **Safe to use** |
| orc | Orc | 3 | 2 | 0 | 0 | 0 | **Safe to use** |
| skeleton | Skeleton | 2 | 2 | 0 | 0 | 0 | **Safe to use** |
| troll | Troll | 5 | 2 | 0 | 0 | 1 | **Assisted Multiattack** |
| wolf | Wolf | 3 | 1 | 0 | 0 | 0 | **Safe to use** |
| zombie | Zombie | 2 | 1 | 0 | 0 | 0 | **Safe to use** |
