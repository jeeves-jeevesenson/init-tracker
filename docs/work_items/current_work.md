...
- **Active Gate:** None
- **Allowed Next Action:** Commit the completed AoE-remove command slice after reviewing scoped diff/status, or open the next bounded server-runtime extraction work item.
