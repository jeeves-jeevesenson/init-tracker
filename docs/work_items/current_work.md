...
- **Active Gate:** None
- **Allowed Next Action:** Open implementation slice `WORK-20260630-runtime-facade-package-skeleton` to add an `init_tracker_server/` package skeleton and app factory compatibility shim. Do not migrate routes, change queue semantics, change WebSockets, change snapshots/cache, change gameplay/combat mutation behavior, or alter deploy/topology.
