...
- **Active Gate:** None
- **Allowed Next Action:** Open the recommended bounded implementation slice (WORK-20260629-runtime-facade-queue-command-aoe-move) or stop if no safe candidate was selected.
