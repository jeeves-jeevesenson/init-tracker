...
- **Active Gate:** None
- **Allowed Next Action:** Open planning/evidence slice `WORK-20260630-runtime-facade-package-boundary-plan` to define the app-host/runtime-service package boundary. Do not open app implementation, route migration, command-semantics cleanup, or package source creation.
