...
class TestBlackAndTanExpansion(unittest.TestCase):
    ...
    def test_suppression_gunner_audit(self):
        """Suppression Gunner area effects should be non-executable after audit."""
        ...
        self.assertFalse(suppress["executable"])
        ...
        self.assertFalse(sweep["executable"])
    ...
    def test_field_medic_multiattack(self):
        """Field Medic should have choose_n Multiattack and non-executable assists."""
    ...
    def test_captain_loading(self):
        ...
        self.assertFalse(not_yet["executable"])
    ...
    def test_major_loading(self):
        ...
        self.assertEqual(example["mechanics"]["ability"], "wis")
